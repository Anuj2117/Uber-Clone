      ...
      <div>
        {suggestions.length === 0 ? (
          ...
          <Box sx={{ width: "100%" , mt:4 }} className="flex flex-col items-center ">
            <Skeleton variant="rectangular" height={50}  className="w-[90%]" animation="wave" sx={{ borderRadius: 1, marginBottom: 2 }}  />
            <Skeleton variant="rectangular" height={50} animation="wave" className="w-[90%]" sx={{ borderRadius: 1, marginBottom: 2 }} />
            <Skeleton variant="rectangular" height={50} animation="wave" className="w-[90%]" sx={{ borderRadius: 1, marginBottom: 2 }} />
            <Skeleton variant="rectangular" height={50} animation="wave" className="w-[90%]" sx={{ borderRadius: 1, marginBottom: 2 }} />
            <Skeleton variant="rectangular" height={50} animation="wave" className="w-[90%]" sx={{ borderRadius: 1, marginBottom: 2 }} />
